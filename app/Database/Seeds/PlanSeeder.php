    ...
    public function run()
    {
        ...
        $plans = [
            [
                ...
                'name'          => 'Free',
                'slug'          => 'free',
                'description'   => 'Try FlowTrack at no cost — timer, projects & desktop app',
                'pricing_model' => 'fixed',
                'price_monthly' => 0.00,
                'price_yearly'  => 0.00,
                'base_price'    => 0.00,
            ...
            [
                ...
                'name'          => 'Starter',
                'slug'          => 'starter',
                'description'   => 'Screenshot monitoring & activity tracking for small teams',
            ...
            [
                ...
                'name'          => 'Professional',
                'slug'          => 'professional',
                'description'   => 'Invoicing, custom roles & advanced reports for growing teams',
                'pricing_model' => 'per_user',
                'price_monthly' => 0.00,
                'price_yearly'  => 0.00,
                'base_price'    => 0.00,
            ...
            [
                ...
                'name'          => 'Enterprise',
                'slug'          => 'enterprise',
                'description'   => 'SSO, white-label & unlimited scale for larger organizations',
                'pricing_model' => 'per_user',
                'price_monthly' => 0.00,
                'price_yearly'  => 0.00,
                'base_price'    => 0.00,
        ...
        $features = array_merge($features, [
            ...
            ['plan_id' => 1, 'feature_key' => 'payroll', 'feature_value' => 'false', 'display_name' => 'No payroll'],
            ['plan_id' => 1, 'feature_key' => 'ai_insights', 'feature_value' => 'false', 'display_name' => 'No AI insights'],
            ['plan_id' => 1, 'feature_key' => 'wellbeing', 'feature_value' => 'false', 'display_name' => 'No wellbeing suite'],
            ['plan_id' => 1, 'feature_key' => 'proof_of_work', 'feature_value' => 'false', 'display_name' => 'No proof-of-work ledger'],
            ['plan_id' => 1, 'feature_key' => 'integrations', 'feature_value' => 'false', 'display_name' => 'No third-party integrations'],
        ...
        $features = array_merge($features, [
            ...
            ['plan_id' => 2, 'feature_key' => 'integrations', 'feature_value' => 'true', 'display_name' => 'Slack, Jira, GitHub & calendar'],
            ['plan_id' => 2, 'feature_key' => 'ai_insights', 'feature_value' => 'false', 'display_name' => 'No AI insights'],
            ['plan_id' => 2, 'feature_key' => 'wellbeing', 'feature_value' => 'false', 'display_name' => 'No wellbeing suite'],
            ['plan_id' => 2, 'feature_key' => 'proof_of_work', 'feature_value' => 'false', 'display_name' => 'No proof-of-work ledger'],
            ['plan_id' => 2, 'feature_key' => 'payroll', 'feature_value' => 'false', 'display_name' => 'No payroll'],
        ...
        $features = array_merge($features, [
            ...
            ['plan_id' => 3, 'feature_key' => 'payroll', 'feature_value' => 'true', 'display_name' => 'Team payroll'],
            ['plan_id' => 3, 'feature_key' => 'ai_insights', 'feature_value' => 'true', 'display_name' => 'AI insights & Ask FlowTrack'],
            ['plan_id' => 3, 'feature_key' => 'wellbeing', 'feature_value' => 'true', 'display_name' => 'Wellbeing & burnout signals'],
            ['plan_id' => 3, 'feature_key' => 'proof_of_work', 'feature_value' => 'true', 'display_name' => 'Proof-of-work ledger'],
            ['plan_id' => 3, 'feature_key' => 'integrations', 'feature_value' => 'true', 'display_name' => 'Full integrations'],
        ...
        $features = array_merge($features, [
            ...
            ['plan_id' => 4, 'feature_key' => 'report_export', 'feature_value' => 'all', 'display_name' => 'Export CSV, PDF, Excel'],
            ['plan_id' => 4, 'feature_key' => 'team_leaderboard', 'feature_value' => 'true', 'display_name' => 'Team leaderboard'],
            ['plan_id' => 4, 'feature_key' => 'invoicing', 'feature_value' => 'true', 'display_name' => 'Advanced invoicing'],
            ['plan_id' => 4, 'feature_key' => 'payroll', 'feature_value' => 'true', 'display_name' => 'Team payroll'],
            ['plan_id' => 4, 'feature_key' => 'ai_insights', 'feature_value' => 'true', 'display_name' => 'AI insights & Ask FlowTrack'],
            ['plan_id' => 4, 'feature_key' => 'wellbeing', 'feature_value' => 'true', 'display_name' => 'Wellbeing & burnout signals'],
            ['plan_id' => 4, 'feature_key' => 'proof_of_work', 'feature_value' => 'true', 'display_name' => 'Proof-of-work ledger'],
            ['plan_id' => 4, 'feature_key' => 'integrations', 'feature_value' => 'true', 'display_name' => 'Full integrations'],
